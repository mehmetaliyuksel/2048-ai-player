...
// if (!Game2048Util.canMove(node.getState().getTiles(),
// node.getState().getAvailableSpace()))
// return;
...
// Node newNode = new Node(new State(tiles, node.getState().isIs2NewlyAdded(),
// getAvailableSpace(tiles)));
...
// Node newNode = new Node(new State(tiles, isIs2NewlyAdded,
// getAvailableSpace(tiles)));
// node.getChildren().add(newNode);
// generateTree(newNode, ply, isMaxDepth);
// }
